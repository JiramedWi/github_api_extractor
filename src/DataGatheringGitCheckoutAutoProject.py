...
# hive_sha = pd.read_pickle(Path(os.path.abspath('../resources/project_demo_30_sec/30_second_use_for_run_java.pkl')))
tsdetect = os.path.abspath('../resources/tsdetect/TestSmellDetector.jar')

project_repo = Repo('/home/pee/IdeaProjects/30-second-java-but-improve-with-sonar')
checkout = project_repo.git.checkout
fetch = project_repo.git.fetch

# Specify the root directory of your Java project
directory_path = '/home/pee/repo/github_api_extractor/resources/project_demo_30_sec'
...
istest = is_test_file(
    '/home/pee/IdeaProjects/30-second-java-but-improve-with-sonar/src/test/java/algorithm/BubbleSortSnippetTest.java')
...
def auto_checkout():
    ...
    for count, url in enumerate(hive_sha['url'].head(1)):
        ...
        subprocess.run(
            ['java', '-jar', '/Users/Jumma/github_repo/github_api_extractor/resources/tsdetect'
