...
data_dir = "/home/pee/repo/github_api_extractor/resources/result_optuna_parameter_tuning_round_2"
...
file_to_save = os.path.join(data_dir, "result_as_df")
for var_name, data in dict_df_cv.items():
    save_data_as_df(data, var_name, file_to_save)
