...
# Check X
data = pd.read_pickle(Path(os.path.abspath(os.path.join(path, '../resources/hive_use_for_run_pre_process.pkl'))))
...
y1 = pd.read_csv(
    Path(os.path.abspath(os.path.join(path, '../resources/tsdetect/all_test_smell/df_test_semantic_smell.csv'))))
y2 = pd.read_csv(
    Path(os.path.abspath(os.path.join(path, '../resources/tsdetect/all_test_smell/df_issue_in_test_step.csv'))))
y3 = pd.read_csv(Path(os.path.abspath(os.path.join(path, '../resources//tsdetect/all_test_smell/df_code_related.csv'))))
y4 = pd.read_csv(Path(os.path.abspath(os.path.join(path, '../resources/tsdetect/all_test_smell/df_dependencies.csv'))))
y5 = pd.read_csv(
    Path(os.path.abspath(os.path.join(path, '../resources/tsdetect/all_test_smell/df_test_execution.csv'))))
...
tf_vectorizer_porter_pre_n_gram_1 = CountVectorizer(preprocessor=pre_process_porterstemmer, ngram_range=(1, 1))
tf_vectorizer_lemma_pre_n_gram_1 = CountVectorizer(preprocessor=pre_process_lemmatizer, ngram_range=(1, 1))
tf_vectorizer_textblob_pre_n_gram_1 = CountVectorizer(preprocessor=pre_process_textblob, ngram_range=(1, 1))
tf_vectorizer_spacy_pre_n_gram_1 = CountVectorizer(preprocessor=pre_process_spacy, ngram_range=(1, 1))

tfidf_vectorizer_porter_pre_n_gram_1 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_porterstemmer,
                                                       ngram_range=(1, 1))
tfidf_vectorizer_lemma_pre_n_gram_1 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_lemmatizer,
                                                      ngram_range=(1, 1))
tfidf_vectorizer_textblob_pre_n_gram_1 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_textblob,
                                                         ngram_range=(1, 1))
tfidf_vectorizer_spacy_pre_n_gram_1 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_spacy, ngram_range=(1, 1))

tf_vectorizer_porter_pre_n_gram_2 = CountVectorizer(preprocessor=pre_process_porterstemmer, ngram_range=(1, 2))
tf_vectorizer_lemma_pre_n_gram_2 = CountVectorizer(preprocessor=pre_process_lemmatizer, ngram_range=(1, 2))
tf_vectorizer_textblob_pre_n_gram_2 = CountVectorizer(preprocessor=pre_process_textblob, ngram_range=(1, 2))
tf_vectorizer_spacy_pre_n_gram_2 = CountVectorizer(preprocessor=pre_process_spacy, ngram_range=(1, 2))

tfidf_vectorizer_porter_pre_n_gram_2 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_porterstemmer,
                                                       ngram_range=(1, 2))
tfidf_vectorizer_lemma_pre_n_gram_2 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_lemmatizer,
                                                      ngram_range=(1, 2))
tfidf_vectorizer_textblob_pre_n_gram_2 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_textblob,
                                                         ngram_range=(1, 2))
tfidf_vectorizer_spacy_pre_n_gram_2 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_spacy, ngram_range=(1, 2))

tf_vectorizer_porter_pre_n_gram_3 = CountVectorizer(preprocessor=pre_process_porterstemmer, ngram_range=(1, 3))
tf_vectorizer_lemma_pre_n_gram_3 = CountVectorizer(preprocessor=pre_process_lemmatizer, ngram_range=(1, 3))
tf_vectorizer_textblob_pre_n_gram_3 = CountVectorizer(preprocessor=pre_process_textblob, ngram_range=(1, 3))
tf_vectorizer_spacy_pre_n_gram_3 = CountVectorizer(preprocessor=pre_process_spacy, ngram_range=(1, 3))

tfidf_vectorizer_porter_pre_n_gram_3 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_porterstemmer,
                                                       ngram_range=(1, 3))
tfidf_vectorizer_lemma_pre_n_gram_3 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_lemmatizer,
                                                      ngram_range=(1, 3))
tfidf_vectorizer_textblob_pre_n_gram_3 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_textblob,
                                                         ngram_range=(1, 3))
tfidf_vectorizer_spacy_pre_n_gram_3 = TfidfVectorizer(use_idf=True, preprocessor=pre_process_spacy, ngram_range=(1, 3))
