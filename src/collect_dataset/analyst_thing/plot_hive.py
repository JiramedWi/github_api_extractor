...
file_path_prefix = "/Users/Jumma/git_repo/github_api_extractor/resources/tsdetect/test_smell_hive/latest_result/tables"  # Example, change as needed
...
dataset_dict = {
    # "code_related": pd.read_csv(f"{file_path_prefix}/summary_cv_full_code_related.csv", na_filter=False),
    # "dependencies": pd.read_csv(f"{file_path_prefix}/summary_cv_full_dependencies.csv", na_filter=False),
    # "issue_in_test_step": pd.read_csv(f"{file_path_prefix}/summary_cv_full_issue_in_test_step.csv", na_filter=False),
    # "test_execution": pd.read_csv(f"{file_path_prefix}/summary_cv_full_test_execution.csv", na_filter=False),
    "test_semantic_smell": pd.read_csv(f"{file_path_prefix}/summary_cv_full_test_semantic_smell.csv", na_filter=False)
}
