...
make_summary_table_cv(csv_path, top_n=5, save_dir=save_dir)
make_summary_table_predict(csv_path, top_n=5, save_dir=save_dir)
make_summary_table_both(csv_path, top_n=5, aggregation_method="average_all", save_dir=save_dir)
make_summary_table_both(csv_path, top_n=5, aggregation_method="average_rank", save_dir=save_dir)
