...
def get_paths():
    ...
    if system_name == "Linux":
        ...
        output_directory = "/home/pee/repo/github_api_extractor/resources/tsdetect/test_smell_hive/latest_result/train_cv_loop"
    elif system_name == "Darwin":  # macOS
        input_directory = "/Users/Jumma/git_repo/github_api_extractor/resources/tsdetect/test_smell_hive/optuna_result"
        output_directory = "/Users/Jumma/git_repo/github_api_extractor/resources/tsdetect/test_smell_hive/train_cv_loop"
    elif system_name == "Windows":
        input_directory = "C:/Users/CAMT/repo/github_api_extractor/resources/tsdetect/test_smell_hive/optuna_result"
        output_directory = "C:/Users/CAMT/repo/github_api_extractor/resources/tsdetect/test_smell_hive/latest_result/train_cv_loop"
    else:
        raise EnvironmentError(f"Unsupported operating system: {system_name}")

    return Path(input_directory), Path(output_directory)
# Logging setup 
log_file = "/home/pee/repo/github_api_extractor/resources/tsdetect/test_smell_hive/latest_result/cv_predict_train_loop_v3.log"
logging.basicConfig(
    level=logging.INFO,
...
def train_cv_loop_runs(dataset_name: str, dataset_path: Path, output_path: Path, n_runs: int = 20):
    ...
    logging.info(f"✅ Finished: cv_loop_result_{dataset_name}.pkl")
    gc.collect()
