...
def get_paths():
    ...
    if system_name == "Linux":
        ...
        output_directory = "C:/Users/CAMT/repo/github_api_extractor/resources/tsdetect/test_smell_hive/latest_result/train_30_loop"
    else:
        raise EnvironmentError(f"Unsupported operating system: {system_name}")

    return Path(input_directory), Path(output_directory)
# Logging setup 
log_file = "C:/Users/CAMT/repo/github_api_extractor/resources/tsdetect/test_smell_hive/latest_result/cv_predict_train_30_loop_v2.log"
logging.basicConfig(
    level=logging.INFO,
