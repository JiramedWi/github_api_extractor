...
from src.preprocess import preProcess_porterstemmer, preProcess_lemmetizer, preProcess_lemmetizer_without_cleantags
import nltk
...
vectorizer_porter_pre = TfidfVectorizer(use_idf=True, preprocessor=preProcess_porterstemmer)
vectorizer_lemm_pre = TfidfVectorizer(use_idf=True, preprocessor=preProcess_lemmetizer)
