...
auto_checkout() {
    ...
    for ((count=0; count < ${#sha_opened[@]}; count++)); do
        ...
        sleep 5
        echo 'checked opened'
        write_file_to_use_in_Jar 'hive' > "../resources/tsdetect/opened_hive_file_${count}_${sha_opened[count]}.csv"
        sleep 5
        java -jar "$tsdetect" "../resources/tsdetect/opened_hive_file_${count}_${sha_opened[count]}.csv"
        sleep 5
        echo 'Done open'
        ...
        sleep 5
        echo 'checked closed'
        write_file_to_use_in_Jar 'hive' > "../resources/tsdetect/closed_hive_file_${count}_${sha_closed[count]}.csv"
        sleep 5
        java -jar "$tsdetect" "../resources/tsdetect/closed_hive_file_${count}_${sha_closed[count]}.csv"
        sleep 5
        echo 'Done closed'
    done
