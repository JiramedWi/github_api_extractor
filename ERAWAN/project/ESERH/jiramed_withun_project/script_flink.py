...
line_token = 'nHKxy92Z03QXUNvN3jfc61AV6fnPgrPC1cVuxeqWzE0'
...
class collect_pulls:
    def __init__(self, url):
        ...
        self.save_path = Path(os.path.abspath('../home/jiramed_withun'))
        self.logger_path = Path(os.path.abspath('../home/jiramed_withun'))
    ...
    def test_get_null(self):
        eurl = self.url
        pulls = github_api.get_pulls_in_detail(eurl[0], eurl[1], 'open', 100, 100, self.token)
        return pulls
...
if __name__ == '__main__':
    ...
    df1 = s.save_testing_pulls(os.path.abspath('../home/jiramed_withun/apache_flink_all_Merged_requests.pkl'))
